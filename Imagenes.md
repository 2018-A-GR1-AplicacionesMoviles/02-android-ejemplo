...
<paths xmlns:android="http://schemas.android.com/apk/res/android">
    <external-path name="my_images" path="DCIM/Camera" />
    <external-path name="my_images2" path="Android/data/com.example.adrianeguez.camara/files/Pictures" />
</paths>
```
 ...
 <uses-permission android:name="android.permission.CAMERA" android:required="true"/>
    ...
    <application
        ...
        <provider
            ...
            android:authorities="com.example.adrianeguez.camara.fileprovider"
